...
* **Severity**: Medium
* Source: [Invalid validation of the `UniswapImplementation::beforeSwap` hook when exact in swap](https://github.com/sherlock-audit/2024-08-flayer-judging/issues/385)
